...
INSERT INTO "new_Website" ("createdAt", "customDomain", "footerRow", "globalStyle", "headerRow", "id", "name", "ownerId", "publishedAt", "siteType", "status", "subdomain", "updatedAt") SELECT "createdAt", "customDomain", "footerRow", "globalStyle", "headerRow", "id", "name", "ownerId", "publishedAt", "siteType", "status", "subdomain", "updatedAt" FROM "Website";
DROP TABLE "Website";
