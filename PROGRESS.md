...
_อัปเดต 2026-07-17 · ก่อนเริ่ม Sprint ถัดไป_
...
- [ ] **Sprint 6 — กันพลาด**: Undo/Redo, UI กู้เวอร์ชันก่อนหน้า (ข้อมูลเก็บแล้วใน `PageVersion`), แก้ข้อความ inline
- [ ] Site switcher ในเมนู admin (สลับไปจัดการ Landing ลูกจากเมนูเดียวกัน)
- [ ] จัดการผู้ใช้ (บทบาท Admin), เมนูเว็บไซต์ (Navigation), Onboarding 4 ขั้นครั้งแรก
