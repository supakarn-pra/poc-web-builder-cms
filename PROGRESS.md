...
- [x] **เมนูเว็บไซต์** (`/administrator/menu`) ใช้งานจริง: เมนูหลัก (navbar) + เมนูส่วนท้าย (siteFooter ได้ prop `links` ใหม่) · ลากจัดลำดับ (dnd-kit) · เลือกหน้าในเว็บหรือลิงก์ภายนอก · บันทึกฉบับร่าง / บันทึกและเผยแพร่
