...
- [x] **ส่วนหัว/ส่วนท้าย** (`/administrator/menu` — เดิมคือหน้าเมนู): แก้ชื่อแบรนด์ เมนูหลัก **ปุ่มด้านขวา (ctaLabel+ctaHref)** ของส่วนหัว และชื่อแบรนด์/คำอธิบาย/ลิขสิทธิ์/เมนูของส่วนท้าย ครบในหน้าเดียว · ลากจัดลำดับเมนู · ปุ่มไป "แก้แบบเต็มจอ" ใน builder · บันทึกฉบับร่าง / บันทึกและเผยแพร่ (siteFooter ได้ prop `links`, navbar ได้ `ctaHref`)
